...
{
    internal class ProductVersionPaymentInstallmentService(IMapper mapper, IProductVersionPaymentInstallmentRepository productVersionPaymentInstallmentRepository,
        IProductVersionPaymentMethodRepository productVersionPaymentMethodRepository) : IProductVersionPaymentInstallmentService
    {
